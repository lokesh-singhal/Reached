        ...
        <div className="lg:w-[65%] w-full">
          <div className="flex flex-col sm:p-20 sm:pl-40 p-10 gap-8">
            ...
            <div className="w-full">
              <div className="bg-gray-100 md:w-100 flex flex-col items-center py-8 rounded-xl shadow-2xl">
                <div className="h-30 w-30 rounded-full bg-gray-400"><UserRound size={110} className='pl-2' /></div>
                <h1 className="text-4xl mt-2 font-semibold text-center">{session?.user.name}</h1>
                <p>Guest</p>
              </div>
            </div>
            <div className="w-full h-px bg-gray-500"></div>
            <div onClick={() => router.push("/myreviews")} className="md:w-80 flex gap-5 p-4 rounded-xl hover:bg-gray-100 items-center cursor-pointer">
